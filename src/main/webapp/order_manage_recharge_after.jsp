					...
					<form class="layui-form x-center" action="" style="width: 80%">
						<div class="layui-form-pane" style="margin-top: 15px;">
							<div class="layui-form-item">
								...
								<br /> <br /> <br /> <label class="layui-form-label">充值方式</label>
								<div class="layui-input-inline">
									<select
						...
						<tbody>
							<tr>
								...
								<td class="td-manage"><a title="查看" href="javascript:;"
									onclick="admin_edit('编辑','order_manage_recharge_examine_after.jsp','4','','510')"
							...
							<div class="layui-form-pane" style="margin-top: 15px;">
								<div class="layui-form-item">
									<label class="layui-form-label"
										style="width: 50px; height: 20px">会员账号</label>
									<div class="layui-input-inline"
									...
									<br /> <br /> <br /> <label class="layui-form-label">日期范围</label>
						...
						<table class="layui-table" style="width: 100%">
							...
							<tbody>
								<tr>
									...
									<td>支付宝</td>
									<td>2013-03-12 12:12:11</td>
									<td class="td-manage"></a> <a title="查看" href="javascript:;"
										onclick="admin_audit('查看','order_manage_recharge_bank_compile_after.jsp','4','','510')"
										...
										onclick="banner_del(this,'1')" style="text-decoration: none">
											<i class="layui-icon">&#xe640;</i>
									</a> <a title="审核" href="javascript:;"
										onclick="admin_audit('审核','order_manage_recharge_bank_after.jsp','4','','510')"
										style="text-decoration: none"> <i class="layui-icon"></i>
									</a></td>
								</tr>
							</tbody>
