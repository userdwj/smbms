...
<body>
	<div class="x-body">
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="desc" name="desc" required=""
						lay-verify="required" placeholder="请输入友情链接名称" autocomplete="off"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				<label for="desc" class="layui-form-label"> <span
					class="x-red">*</span>广告位置
				</label>
				<div class="layui-input-inline">
				<select style="display: inline-block;width:190px;height: 38px;border-color:#e6e6e6" name="">
				<option value="0">请选择位置</option>
				<option value="1">首页焦点图724*224</option>
				<option value="2">左侧广告222*193</option>
				</select>
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red">*</span>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="link" name="link" required=""
						lay-verify="required" placeholder="http://www.xuebingsi.com"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">图片 </label> <!-- <img
					id="LAY_demo_upload" width="400" src="./images/banner.png"> -->
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					...
					可用
					</label> <input type="radio" id="link" name="link" required=""
