...
<html>
    ...
    <body style="background-color: #393D49">
        <div class="x-box">
            ...
            <div class="x-mid">
                <div class="x-avtar">
                    <img src="${pageContext.request.contextPath }/static/after/images/logo.png" alt="">
                </div>
                <div class="input">
                    <form class="layui-form">
                        ...
                        <!-- <input type="submit" class="layui-btn" lay-filter="save" value="登录" > -->
