...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>其他设置</cite></a>
			<a><cite>投诉建议</cite></a>
		...
		<table class="layui-table" style="width: 100%">
			...
			<tbody>
				<tr>
					...
					<td>关于页面显示展示...</td>
					<td>张三</td>
					<td>2013-11-26 17:09:15</td>
					<td>留言</td>
					<td>已处理</td>
					<td>是</td>
					<td class="td-manage"><a title="编辑" href="javascript:;"
						onclick="admin_edit('编辑','system_complain_dispose_after.jsp','4','','510')"
						class="ml-5" style="text-decoration: none"> <i
							class="layui-icon">&#xe642;</i>
					</a> <a title="删除" href="javascript:;" onclick="admin_del(this,'1')"
