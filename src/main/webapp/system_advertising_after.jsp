...
<body>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="banner_add('添加用户','system_advertising_add_after.jsp','600','500')">
		...
		<table class="layui-table" style="width: 100%">
			...
			<tbody id="x-img">
				<tr>
					...
					<td>百度</td>
					<td>广告位置</td>
					<td><img src="./images/banner.png" width="200" alt="">图片
					</td>
					...
					<td class="td-manage">
						...
						onclick="banner_edit('编辑','system_advertising_modification_after.jsp','4','','510')"
